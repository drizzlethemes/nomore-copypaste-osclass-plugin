...
function nm_copypaste_plugin_actions() {
  ...
  if (Params::getParam('file') != 'nm_copypaste_plugin/admin.php') {
    return '';
  }
  ...
  if ($option == 'nomoresettings') {
    ...
    osc_redirect_to(osc_admin_render_plugin_url('nm_copypaste_plugin/admin.php'));
  }
}
...
function nm_copypaste_plugin_admin() {
  osc_admin_render_plugin('nm_copypaste_plugin/admin.php');
}


function dd_nm_related() {
...
osc_add_route('nm-copypaste-plugin-admin-conf', 'nm_copypaste_plugin', 'nm_copypaste_plugin', osc_plugin_folder(__FILE__).'admin.php'); 
osc_add_route('nm-copypaste-plugin-admin-help', 'nm_copypaste_plugin', 'nm_copypaste_plugin', osc_plugin_folder(__FILE__).'help.php');
