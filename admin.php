...
<div class="plugin-page">
	<div class="col5">
        ...
        <form action="<?php echo osc_admin_render_plugin_url('nm_copypaste_plugin/admin.php'); ?>" class="form-horizontal" method="post">
        ...
        <div class="footer">
            <p class="form-row">
            &copy; <?php echo date('Y'); ?> <?php _e('Nomore Copypaste Plugin', 'nm_copypaste_plugin'); ?> - <a href="<?php echo osc_admin_render_plugin_url('nm_copypaste_plugin/help.php'); ?>"><?php _e('Help', 'nm_copypaste_plugin'); ?></a> - <a href="http://www.drizzlethemes.com/">DrizzleThemes</a>.
            </p>
        </div>
	</div><!-- /Col5 -->
    
    <div class="col6">
    	<div id="nm_copypaste" class="promobox">
			<?php echo dd_nm_related();?>
        </div>
    </div><!-- /COL6 -->
